        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <div class="post-preview">
                    <a href="single?title=<?= $article->title; ?>&content=<?= $article->content; ?>&sub_title=<?= $article->sub_title ?>&author=<?= $article->autorLogin; ?>&date=<?= $article->created_at; ?>"">
                    <h2 class="post-title">
                        <?= $article->title; ?>
                    </h2>
